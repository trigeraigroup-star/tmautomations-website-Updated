...
export default function Scene({id,name,titleId,children,length=150,next}:{id:string;name:string;titleId:string;children:ReactNode;length?:number;next?:string}){
